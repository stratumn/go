...
const (
	...
	CarolPrivateKey       = "-----BEGIN ED25519 PRIVATE KEY-----\nME4CAQAwBQYDK2VwBEIEQFZGI+q09BP5eVuCywCn6E5A1mpo0DhSeNs+HLpWPO8b\nKFQAZfFFc++UFnigX+fQO51TT0OmJVQF7fs5fFIp+DY=\n-----END ED25519 PRIVATE KEY-----\n"
	CarolPublicKey        = "-----BEGIN ED25519 PUBLIC KEY-----\nMCowBQYDK2VwAyEAKFQAZfFFc++UFnigX+fQO51TT0OmJVQF7fs5fFIp+DY=\n-----END ED25519 PUBLIC KEY-----\n"
	CarolPublicKeyEscaped = `-----BEGIN ED25519 PUBLIC KEY-----\nMCowBQYDK2VwAyEAKFQAZfFFc++UFnigX+fQO51TT0OmJVQF7fs5fFIp+DY=\n-----END ED25519 PUBLIC KEY-----\n`
)
