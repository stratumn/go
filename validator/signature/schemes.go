...
func MatchScheme(sigType string) (string, error) {
	...
	return "", errors.Wrapf(ErrUnsupportedSignatureType, "Unhandled signature schema [%s]", sigType)
}
...
// - RSA: signatures must computed using PKCS1-v1_5. What should be signed is the SHA512 sum of the document, not the document itself.
