...
LICENSED_FILES=$(shell find . -name '*.go' | grep -Ev "batchfossilizer|bcbatchfossilizer|blockchain|postgresstore|rethinkstore|btcfossilizer|dummybatchfossilizer|postgrestmpop|rethinktmpop")
