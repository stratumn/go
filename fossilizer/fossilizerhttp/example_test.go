...
func Example() {
	...
	a := dummyfossilizer.New(&dummyfossilizer.Config{Version: "0.2.0", Commit: "abc"})
	...
	fmt.Printf("%s", info)
	// Output: {"adapter":{"name":"dummy","description":"Stratumn Dummy Fossilizer","version":"0.2.0","commit":"abc"}}
}
